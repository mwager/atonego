...
function configureExpress() {
    ...
    app.configure(function () {
        ...
        isLive = true; // process.env.OPENSHIFT_MONGODB_DB_PORT;
...
function main(conf) {
    ...
    if(ENV !== 'test') { // dont listen here when testing
        var ipaddr = 'none'; //  process.env.PORT; process.env.OPENSHIFT_NODEJS_IP   || config[ENV].HOST;
        var port   = process.env.PORT;// process.env.OPENSHIFT_NODEJS_PORT || config[ENV].PORT;
